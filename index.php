...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Chris Muiruri : : Portfolio</title>
        ...
        <link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.css">
        <link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.theme.css">
    ...
    <body>
        ...
        <div class="home-page">
            ...
            <div class="introduction">
                ...
                <div class="intro-content">
                    <h1>Hey!<br>
                        I'M <span>CHRIS</span> MUIRURI</h1>
                    <h2>WEB/MOBILE DEVELOPER</h2>
                    <p class="social-media hidden-xs">
                        <a href="#" class="fa fa-facebook" data-toggle="tooltip" title="Facebook"></a>
                        <a href="http://stackoverflow.com/users/5033500/christopher-m" class="fa fa-stack-overflow" data-toggle="tooltip" title="Stack Overflow"></a>
                    ...
                    <div class="education-container col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                        <div class="item">
                            ...
                            <div class="education-content">
                                <h3>Starnet College<span> / 2013</span></h3>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="education-content">
                                <h3>Jomo Kenyatta University of Agriculture &amp; Technology<span> / 2014</span></h3>
                            </div>
                        </div>
                    ...
                    <div class="experience-container col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                        <div class="item">
                            ...
                            <div class="experience-content">
                                <h3>Senior Frontend Developer <span> / 2016<br>
                                        Bean Interactive Limited.</span></h3>
                                <p>
                                    
                                    Maecenas hendrerit euismod lorem, vitae mollis odio consectetur a.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="experience-content">
                                <h3>Applications Developer<span> / 2015<br>
                                        Africa Cloud Space.</span></h3>
                                <p>
                        ...
                        <div class="item">
                            ...
                            <div class="experience-content">
                                <h3>Website Developer<span> / 2013<br>
                                        Newwork Computer System.</span></h3>
                                <p>
                                    Maecenas hendrerit euismod lorem, vitae mollis odio consectetur a.
                                </p>
                            </div>
                    ...
                    <div class="project-container">
                        ...
                        <div class="projet-items clearfix" id="projects">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mix graphic-design">
                                <div class="project">
                                    <img src="images/portfolio/thumbs/drnguru.jpg" alt="">
                                    <div class="ovrly">
                                    </div>
                                    <div class="buttons">
                                        <a href="#" class="fa fa-link hidden"></a>
                            ...
                            <div class="pop-up-box" id="portfolio-1">
                                ...
                                <div class="popup-content">
                                    <h3>Garden Family Dental Center</h3>
                                    <p>
                                        NFDC & GFDC are comprehensive, 21<sup>st</sup> century dental clinics that are here to run out scary assumptions 'stuffy' stereotypes about dentists, and dentistry as a whole. Embrace your dental hygiene and be part of the NFDC & GFDC family for that “cozy atmosphere” merged with dental expertise; supported by certified, sterile, good-natured patient care standards and dental services.
                                    </p>
                                    <a href="www.dnguru.com" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-2">
                                ...
                                <div class="popup-content">
                                    ...
                                    <a href="www.blaze.co.ke/">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-3">
                                ...
                                <div class="popup-content">
                                    <h3>Highchem Group</h3>
                                    <p>
                                        HighChem Group is a conglomerate of companies operating within East Africa devoted to improve health and, productivity in crop science, veterinary, home-care, human pharmaceuticals and hospital consumables plus diagnostic technologies through the best practices possible.
                                    </p>
                                    <a href="www.highchem.co.ke/">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-4">
                                ...
                                <div class="popup-content">
                                    <h3>Mdahalo</h3>
                                    <p>
                                        A Kenyan based non-governmental organization which works to contribute to the improvement of human life by promoting cooperation between ethnic and racial communities. Mdahalo works independently, governed by a national board with an international advisory council consisting of ethnic and race relations experts, practitioners and researchers.
                                    </p>
                                    <a href="http://mdahalo.org/" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-5">
                                ...
                                <div class="popup-content">
                                    <h3>Par Excellence Invest</h3>
                                    <p>
                                        Par Excellence Invest is an investor-focused entity that promotes an investment appetite in Kenya. We work in conjunction with Investment Principals who include Britam, Genghis Capital and Suntra Investment Bank.
                                    </p>
                                    <a href="http://invest.parexcellence.co.ke/" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-6">
                                ...
                                <div class="popup-content">
                                    <h3>Pefric EA Ltd</h3>
                                    <p>
                                        Pefric (EA) limited imports and distributes all hospital equipments, hospital furnitures, laboratory equipments, reagents and all rapid test diagnostics strips and monitoring devices in Kenya and the whole of East Africa.
                                    </p>
                                    <a href="www.pefricea.co.ke" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-7">
                                ...
                                <div class="popup-content">
                                    ...
                                    <a href="www.opticom.co.ke" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-8">
                                ...
                                <div class="popup-content">
                                    <h3>mobisms Landing Page</h3>
                                    <p>
                                        Send custom and personalized bulk SMS(s)like: Promotional, new products , E-Bills, exam results, alerts, among other messages to large group of recipients at an affordable cost.
                                    </p>
                                    <a href="www.mobisms.co.ke" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-9">
                                ...
                                <div class="popup-content">
                                    <h3>Nellions Canvas WebApp</h3>
                                    <p>
                                        Quisque in tempor sapien, et cursus neque. Nunc pulvinar diam ac dapibus mollis. Etiam id iaculis lorem. Donec bibendum volutpat ante, eu consequat nisi suscipit at. Etiam interdum augue dolor, id auctor felis volutpat sed. Phasellus id ex ultrices, tempus leo eget, volutpat diam. In sit amet magna faucibus, molestie nisi in, hendrerit libero. Morbi auctor velit sagittis, elementum lorem eget, imperdiet nisl.
                                    </p>
                                    <a href="www.nellions.co.ke" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-10">
                                ...
                                <div class="popup-content">
                                    <h3>IkoMali App</h3>
                                    <p>
                                        Ikomali allows you to buy airtime at a discount from any operator (Safaricom, Airtel, Orange etc), buy tokens, shop online for quality (Phones, TVs, Furniture, Software, etc ) and pay for shopping getting free airtime and loyalty points.
                                    </p>
                                    <a href="https://play.google.com/store/apps/details?id=www.africacloudspace.com.iKomali&hl=en" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mix web-design">
                                <div class="project">
                                    <img src="images/portfolio/thumbs/image_11.jpg" alt="">
                                    <div class="ovrly">
                                    </div>
                                    <div class="buttons">
                                        <a href="#" class="fa fa-link hidden"></a>
                                        <a href="#portfolio-11" class="fa fa-search show-popup"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-11">
                                <img alt="" src="images/portfolio/image_11.jpg" class=" hidden-xs">
                                <div class="popup-content">
                                    <h3>Governors' Balloon Safaris</h3>
                                    <p>
                                        For those looking for an adventure of a different kind, we offer Hot Air Ballooning over the Masai Mara. The adventure begins just before dawn. The first, pink tongues of sunlight flicker across the skies as the hot air balloon fills, then rises. Suspended in a basket beneath the rainbow-coloured canopy, you're off for a wildlife viewing adventure with an entirely different perspective.
                                    </p>
                                    <a href="www.governorsballoonsafaris.com" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mix web-design">
                                <div class="project">
                                    <img src="images/portfolio/thumbs/image_12.jpg" alt="">
                                    <div class="ovrly">
                                    </div>
                                    <div class="buttons">
                                        <a href="#" class="fa fa-link hidden"></a>
                                        <a href="#portfolio-12" class="fa fa-search show-popup"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-12">
                                <img alt="" src="images/portfolio/image_12.jpg" class=" hidden-xs">
                                <div class="popup-content">
                                    <h3>Surf</h3>
                                    <p>
                                        Surfspot, a WiFi hotspot service, is now available in  market areas across Buruburu, Donholm, Jericho, Umoja 1&2, Makadara and now CBD! We’re growing fast and soon will be in a neighborhood near you. Using Surfspot is easy and fun. Just follow these simple steps.
                                    </p>
                                    <a href="http://stage.surf.co.ke/" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mix web-design">
                                <div class="project">
                                    <img src="images/portfolio/thumbs/image_13.jpg" alt="">
                                    <div class="ovrly">
                                    </div>
                                    <div class="buttons">
                                        <a href="#" class="fa fa-link hidden"></a>
                                        <a href="#portfolio-13" class="fa fa-search show-popup"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pop-up-box" id="portfolio-13">
                                <img alt="" src="images/portfolio/image_13.jpg" class=" hidden-xs">
                                <div class="popup-content">
                                    <h3>MySchoolChart System</h3>
                                    <p>
                                        Online school management system, my school chart, launched in kenya
                                    </p>
                                    <a href="www.myschoolchart.com" target="_blank">PREVIEW</a>
                                </div>
                            </div>
                ...
                <div class="testimonials clearfix">
                    ...
                    <div class="testimonials-container col-sm-10 col-sm-offset-1">
                        <div class="owl-carousel">
                            ...
                            <div>
                                <p>
                                    <i class="fa fa-quote-left"></i>I'm very much happy with what Chris and the Team have done to our website<i class="fa fa-quote-right"></i>
                                </p>
                                <h3>Ariana Grammaticas (Governors' Balloon Safaris)</h3>
                            </div>
            ...
            <div class="content-container col-md-7 col-sm-12">
                ...
                <div class="contact-details clearfix">
                    ...
                    <div class="col-xs-12 social-media">
                        <a href="#" class="fa fa-facebook" data-toggle="tooltip" title="Facebook"></a>
                        <a href="#" class="fa fa-stack-overflow" data-toggle="tooltip" title="Stack Overflow"></a>
                        <a href="#" class="fa fa-linkedin" data-toggle="tooltip" title="Linkedin"></a>
                        <a href="#" class="fa fa-behance" data-toggle="tooltip" title="Behance"></a>
                    </div>
        ...
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/viewport-units-buggyfill/0.6.0/viewport-units-buggyfill.hacks.js"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/viewport-units-buggyfill/0.6.0/viewport-units-buggyfill.js"></script>
        <script>
